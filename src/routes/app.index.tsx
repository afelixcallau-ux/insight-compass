...
import { Sparkles, TrendingUp, TrendingDown, Package, Users, Loader2, AlertCircle, CheckCircle2, Info } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <UploadExcel isMine onDone={() => window.location.reload()} />
        <UploadExcel isMine={false} onDone={() => window.location.reload()} />
      </div>
